...
class iCal
{
	...
	public function __construct($years)
	{
		...
		foreach($years as $year)
		{
			...
			array_push(
				$this->_events[$year],
				new iCalEvent($this->winterDate($year, 18, 6),
					'Konudagur'
				)
			);
			...
			array_push(
				$this->_events[$year],
				new iCalEvent($this->easterDate($year, -3),
					'Skírdagur'
				)
			);
			...
			array_push(
				$this->_events[$year],
				new iCalEvent($this->easterDate($year, -2),
					'Föstudagurinn langi'
				)
			);
			...
			array_push(
				$this->_events[$year],
				new iCalEvent($this->easterDate($year),
					'Páskadagur'
				)
			);
			...
			array_push(
				$this->_events[$year],
				new iCalEvent($this->getStartDate(1, 5, $year),
					'Verkalýðsdagurinn'
				)
			);
